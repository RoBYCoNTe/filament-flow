...
hero:
  name: "Filament Flow"
  text: "Business Process Manager for Filament"
  tagline: Seamlessly integrate Spatie Laravel Model States into your Filament admin panel with visual state transitions, custom forms, and intuitive UI components.
  actions:
    - theme: brand
      text: Get Started
